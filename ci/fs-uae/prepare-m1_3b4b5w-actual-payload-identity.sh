...
LOADER=${LOADER:-out/m1-3b4b5w/m68kdeb-loader-68030-identity-qual}
...
cp "$LOADER" "$OUT/aros-root/m68kdeb-loader-68030-identity-qual"
...
SYS:m68kdeb-loader-68030-identity-qual SYS:vmlinux-m68k-amiga SYS:initramfs-m68kdeb.gz 5 >SYS:m68kdeb-5w-report.txt
...

{
  ...
  echo "role=M1.3b.4b.5w actual production-loader payload identity qualification"
  ...
  sha256sum "$OUT/rom/aros-rom.bin" "$OUT/rom/aros-ext.bin" \
    "$OUT/aros-root/m68kdeb-loader-68030-identity-qual" \
