...
PROBE=${PROBE:-out/m1-3b4b5n/m68kdeb-68030-runtime-probe}
OUT=${OUT:-out/m1-3b4b5n}
...
cp "$PROBE" "$OUT/aros-root/m68kdeb-68030-runtime-probe"
rm -f "$OUT/aros-root/m1-3b4b5n-"*.marker "$OUT/aros-root/m68kdeb-5n-report.txt"

cat > "$OUT/aros-root/S/Startup-Sequence" <<'EOF'
C:Echo "M1.3b.4b.5n Startup-Sequence reached" >SYS:m1-3b4b5n-startup.marker
SYS:m68kdeb-68030-runtime-probe >SYS:m68kdeb-5n-report.txt
C:Echo "M1.3b.4b.5n probe returned" >SYS:m1-3b4b5n-returned.marker
C:Wait 300
EOF
